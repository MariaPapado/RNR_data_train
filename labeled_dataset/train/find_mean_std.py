...
images = []
for split in splits:
    image_paths = glob.glob("/home/mariapap/DATASETS/dataset_FP_v0/dataset_FP/PATCHES/{}/im1/*.png".format(split))  # Adjust the path and extension as necessary
    ...
    image_paths = glob.glob("/home/mariapap/DATASETS/dataset_FP_v0/dataset_FP/PATCHES/{}/im2/*.png".format(split))  # Adjust the path and extension as necessary
