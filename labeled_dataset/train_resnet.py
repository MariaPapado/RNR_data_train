...
dataset_path = '/home/mariapap/DATASETS/dataset_FP_v0/dataset_FP/PATCHES/'


with open("/home/mariapap/DATASETS/dataset_FP_v0/dataset_FP/PATCHES/lists/train_list.txt", "r") as file:
    train_ids = [line.strip() for line in file.readlines()]
#(train_ids)

with open("/home/mariapap/DATASETS/dataset_FP_v0/dataset_FP/PATCHES/lists/val_list.txt", "r") as file:
...
weight_tensor[0]= 0.15
weight_tensor[1]= 0.18
...
optimizer = torch.optim.Adam(modified_resnet.parameters(), lr=0.000005)
