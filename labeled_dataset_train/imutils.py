...
def normalize_img(img, mean=[106.668, 110.648, 97.997], std=[59.781, 55.186, 54.901]):  # 128x128 (b)
#def normalize_img(img, mean=[109.428, 112.109, 99.401], std=[59.791, 54.780, 54.409]):  # 128x128 (b)
